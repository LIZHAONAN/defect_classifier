...
mask = create_circular_mask(300,300)
...
class defectDataset_df(Dataset):
    def __init__(self, df = pd.read_csv('/home/rliu/yolo2/v2_pytorch_yolo2/data/an_data/VOCdevkit/VOC2007/csv_labels/train.csv', sep=" "), img_path='/home/rliu/yolo2/v2_pytorch_yolo2/data/an_data/VOCdevkit/VOC2007/JPEGImages/', window_size=50, pad_size=50, mask = create_circular_mask(200,200), transforms=None, old_transform=False):
        """
        Args:
...
def split_and_sample(
    ...
    df_yolo = pd.read_csv('/home/zli/yolo2_dm/results/train_yolo.csv', sep=' ')
...
class defectDataset_convolution(Dataset):
    def __init__(self, image_index = 6501, img_path='/home/rliu/yolo2/v2_pytorch_yolo2/data/an_data/VOCdevkit/VOC2007/JPEGImages/', coord_path = '/home/zli/notebook/eval/coord_list.npy',window_size=45, mask = create_circular_mask(200,200), transforms=None, old_transform=False):
        """
        Args:
