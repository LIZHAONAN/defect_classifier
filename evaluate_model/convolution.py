...
batch_size = 512
num_workers = 8
output_path = '/home/zli/convolution_test/'
...
model_uniform = torch.load(path_to_uniform_model, map_location=None)
model_uniform.eval()
model_hard = torch.load(path_to_hard_model, map_location=None)
model_hard.eval()
model_FNN = torch.load(path_to_FNN_model, map_location=None)
model_FNN.eval()
