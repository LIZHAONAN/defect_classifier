...
output_path = '/home/zli/defect_reduced/models/python/res34_600epo_uniform_06-30-19-new_transform-new_train.model'
batch_size = 256
non_pos_ratio = 4
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        testset = defectDataset_df(df = split_and_sample(df_labels = pd.read_csv('/work/zli/new_data/new_test.csv'),
                                  method = 'uniform',n_samples = 500), window_size = window_size, transforms=old_data_transform, old_transform=True, img_path='/work/zli/new_data/images/')
